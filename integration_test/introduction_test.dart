...
void main() {
  ...
  setUp(() async {
    ...
    _cRepoIntroducer = ContactsRepository(
  ...
  test(
    'Introducer connects with Alice and Bob,introduces them, they connect',
    () async {
      ...
      expect(
        updateSuccessA,
        true,
        reason: 'Expected updating contact B to work',
      );
      expect(
      ...
      expect(
        updateSuccessB,
        true,
        reason: 'Expected updating contact A to work',
      );
