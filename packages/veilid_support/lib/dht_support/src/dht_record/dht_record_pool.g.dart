...
_DHTRecordPoolAllocations _$DHTRecordPoolAllocationsFromJson(
  ...
  childrenByParent: json['children_by_parent'] == null
      ? const IMapConst<String, ISet<RecordKey>>({})
      : IMap<String, ISet<RecordKey>>.fromJson(
          json['children_by_parent'] as Map<String, dynamic>,
          (value) => value as String,
          (value) => ISet<RecordKey>.fromJson(
            value,
            (value) => RecordKey.fromJson(value),
          ),
        ),
  parentByChild: json['parent_by_child'] == null
      ? const IMapConst<String, RecordKey>({})
      : IMap<String, RecordKey>.fromJson(
          json['parent_by_child'] as Map<String, dynamic>,
          (value) => value as String,
          (value) => RecordKey.fromJson(value),
        ),
  rootRecords: json['root_records'] == null
      ? const ISetConst<RecordKey>({})
      : ISet<RecordKey>.fromJson(
          json['root_records'],
          (value) => RecordKey.fromJson(value),
        ),
...
Map<String, dynamic> _$DHTRecordPoolAllocationsToJson(
  ...
  'root_records': instance.rootRecords.toJson((value) => value.toJson()),
  'debug_names': instance.debugNames.toJson((value) => value, (value) => value),
};
...
_OwnedDHTRecordPointer _$OwnedDHTRecordPointerFromJson(
  ...
  owner: BareKeyPair.fromJson(json['owner']),
);
