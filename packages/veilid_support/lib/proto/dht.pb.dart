...
class DHTData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'dht'),
      createEmptyInstance: create)
    ..pPM<$0.RecordKey>(1, _omitFieldNames ? '' : 'keys',
        subBuilder: $0.RecordKey.create)
    ..aOM<$0.HashDigest>(2, _omitFieldNames ? '' : 'hash',
        subBuilder: $0.HashDigest.create)
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$0.RecordKey> get keys => $_getList(0);

  /// Hash of reassembled data to verify contents
  @$pb.TagNumber(2)
  $0.HashDigest get hash => $_getN(1);
  @$pb.TagNumber(2)
  set hash($0.HashDigest value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class OwnedDHTRecordPointer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'dht'),
      createEmptyInstance: create)
    ..aOM<$0.RecordKey>(1, _omitFieldNames ? '' : 'recordKey',
        subBuilder: $0.RecordKey.create)
    ..aOM<$0.BareKeyPair>(2, _omitFieldNames ? '' : 'owner',
        subBuilder: $0.BareKeyPair.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set recordKey($0.RecordKey value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set owner($0.BareKeyPair value) => $_setField(2, value);
  @$pb.TagNumber(2)
