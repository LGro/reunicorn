        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (darkMode ? Colors.black : Colors.white).withAlpha(240),
          ...
          Stack(
            clipBehavior:
                Clip.none, // Allows the icon to overflow outside the circle
            children: [
  ...
  Widget build(BuildContext context) => BlocProvider(
    ...
    child: BlocConsumer<MapCubit, MapState>(
      ...
      builder: (context, state) =>
          (state.cachePath == null || state.profileInfo == null)
          ...
          : FlutterMap(
              ...
              children: <Widget>[
                    ...
                    markers: <Marker>[
                      ...
                      ...filterTemporaryLocations(
                        ...
                        (l) => _buildMarker(
                          ...
                          darkMode: context.read<SettingsRepository>().darkMode,
                ...
                RichAttributionWidget(
                  ...
                  attributions: [
                    if (context.read<SettingsRepository>().mapUrl.contains(
                      'maptiler',
                    ))
