...
class _LinkToSystemContactPageState extends State<LinkToSystemContactPage> {
  ...
  Widget _body(
    ...
    LinkToSystemContactState state,
  ) => Container(
                  ...
                  Expanded(
                    child: DropdownMenu<Account>(
                      ...
                      dropdownMenuEntries: state.accounts
                          .map(
                            (a) => DropdownMenuEntry(label: a.name, value: a),
                          )
                          .toList(),
                    ),
                  ),
          ...
          Expanded(
            child: SearchableList(
              ...
              buildItemWidget: (contact) => ListTile(
                ...
                enabled: state.linkedSystemContactIds.contains(contact.id),
                onTap: () => showDialog<void>(
                  ...
                  builder: (alertContext) => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        const Text(
                          'Reunicorn will automatically update '
