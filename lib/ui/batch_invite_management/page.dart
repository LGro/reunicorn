...
class _BatchInvitesPageState extends State<BatchInvitesPage> {
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  helperMaxLines: 100,
                  errorMaxLines: 100,
                  helperText: 'Only alpha numeric characters i.e. letters and '
                      'numbers are allowed',
                ),
  ...
  Widget build(BuildContext _) => Scaffold(
        ...
        body: BlocProvider(
          ...
          child:
              BlocBuilder<BatchInvitesCubit, BatchInvitesState>(builder: _body),
        ),
      );
}
...
Widget existingBatchWidget(BuildContext context, Batch batch) => Column(
      ...
      children: [
        ...
        Row(
          children: [
            Text(
                'Due date ${DateFormat('yyyy-MM-dd').format(batch.expiration)}, '),
            DhtStatusWidget(
                recordKey: batch.dhtRecordKey, statusWidgets: const {}),
          ],
        ),
