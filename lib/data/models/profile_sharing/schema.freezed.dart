...
/// Shared contact details of author
 ...
 List<ContactIntroduction> get introductions;/// Keys for DHT records the author asks the recipient to pin for them
 List<RecordKey> get recordsToPin;/// Long lived identity key, used for example to derive a connection
/// attestation for enabling others to discover shared contacts
 PublicKey? get identityKey;/// Recipient specific push notification topic the recipient can use to
/// trigger notifications for the author via the Reunicorn Veilid Push Bridge
 String? get pushNotificationTopic;/// Schema version to facilitate data migration
...
@useResult
$Res call({
 ContactDetails details, Map<String, ContactAddressLocation> addressLocations, Map<String, ContactTemporaryLocation> temporaryLocations, List<String> connectionAttestations, List<ContactIntroduction> introductions, List<RecordKey> recordsToPin, PublicKey? identityKey, String? pushNotificationTopic, int schemaVersion
});
...
/// Create a copy of ContactSharingSchemaV3
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? details = null,Object? addressLocations = null,Object? temporaryLocations = null,Object? connectionAttestations = null,Object? introductions = null,Object? recordsToPin = null,Object? identityKey = freezed,Object? pushNotificationTopic = freezed,Object? schemaVersion = null,}) {
...
as List<ContactIntroduction>,recordsToPin: null == recordsToPin ? _self.recordsToPin : recordsToPin // ignore: cast_nullable_to_non_nullable
as List<RecordKey>,identityKey: freezed == identityKey ? _self.identityKey : identityKey // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ContactDetails details,  Map<String, ContactAddressLocation> addressLocations,  Map<String, ContactTemporaryLocation> temporaryLocations,  List<String> connectionAttestations,  List<ContactIntroduction> introductions,  List<RecordKey> recordsToPin,  PublicKey? identityKey,  String? pushNotificationTopic,  int schemaVersion)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContactSharingSchemaV3() when $default != null:
return $default(_that.details,_that.addressLocations,_that.temporaryLocations,_that.connectionAttestations,_that.introductions,_that.recordsToPin,_that.identityKey,_that.pushNotificationTopic,_that.schemaVersion);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ContactDetails details,  Map<String, ContactAddressLocation> addressLocations,  Map<String, ContactTemporaryLocation> temporaryLocations,  List<String> connectionAttestations,  List<ContactIntroduction> introductions,  List<RecordKey> recordsToPin,  PublicKey? identityKey,  String? pushNotificationTopic,  int schemaVersion)  $default,) {final _that = this;
switch (_that) {
case _ContactSharingSchemaV3():
return $default(_that.details,_that.addressLocations,_that.temporaryLocations,_that.connectionAttestations,_that.introductions,_that.recordsToPin,_that.identityKey,_that.pushNotificationTopic,_that.schemaVersion);}
}
...
/// Keys for DHT records the author asks the recipient to pin for them
 final  List<RecordKey> _recordsToPin;
/// Keys for DHT records the author asks the recipient to pin for them
@override@JsonKey() List<RecordKey> get recordsToPin {
  if (_recordsToPin is EqualUnmodifiableListView) return _recordsToPin;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_recordsToPin);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContactSharingSchemaV3&&(identical(other.details, details) || other.details == details)&&const DeepCollectionEquality().equals(other._addressLocations, _addressLocations)&&const DeepCollectionEquality().equals(other._temporaryLocations, _temporaryLocations)&&const DeepCollectionEquality().equals(other._connectionAttestations, _connectionAttestations)&&const DeepCollectionEquality().equals(other._introductions, _introductions)&&const DeepCollectionEquality().equals(other._recordsToPin, _recordsToPin)&&(identical(other.identityKey, identityKey) || other.identityKey == identityKey)&&(identical(other.pushNotificationTopic, pushNotificationTopic) || other.pushNotificationTopic == pushNotificationTopic)&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,details,const DeepCollectionEquality().hash(_addressLocations),const DeepCollectionEquality().hash(_temporaryLocations),const DeepCollectionEquality().hash(_connectionAttestations),const DeepCollectionEquality().hash(_introductions),const DeepCollectionEquality().hash(_recordsToPin),identityKey,pushNotificationTopic,schemaVersion);
...
/// Create a copy of ContactSharingSchemaV3
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? details = null,Object? addressLocations = null,Object? temporaryLocations = null,Object? connectionAttestations = null,Object? introductions = null,Object? recordsToPin = null,Object? identityKey = freezed,Object? pushNotificationTopic = freezed,Object? schemaVersion = null,}) {
...
as List<ContactIntroduction>,recordsToPin: null == recordsToPin ? _self._recordsToPin : recordsToPin // ignore: cast_nullable_to_non_nullable
as List<RecordKey>,identityKey: freezed == identityKey ? _self.identityKey : identityKey // ignore: cast_nullable_to_non_nullable
as PublicKey?,pushNotificationTopic: freezed == pushNotificationTopic ? _self.pushNotificationTopic : pushNotificationTopic // ignore: cast_nullable_to_non_nullable
as String?,schemaVersion: null == schemaVersion ? _self.schemaVersion : schemaVersion // ignore: cast_nullable_to_non_nullable
as int,
