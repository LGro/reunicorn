...
@useResult
$Res call({
 ContactDetails details, Map<String, ContactAddressLocation> addressLocations, Map<String, ContactTemporaryLocation> temporaryLocations, List<String> connectionAttestations, List<ContactIntroduction> introductions, List<RecordKey> recordsToPin, PublicKey? identityKey, PublicKey? introductionKey, String? pushNotificationTopic, int schemaVersion
});
...
/// Create a copy of ContactSharingSchemaV3
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? details = null,Object? addressLocations = null,Object? temporaryLocations = null,Object? connectionAttestations = null,Object? introductions = null,Object? recordsToPin = null,Object? identityKey = freezed,Object? introductionKey = freezed,Object? pushNotificationTopic = freezed,Object? schemaVersion = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ContactDetails details,  Map<String, ContactAddressLocation> addressLocations,  Map<String, ContactTemporaryLocation> temporaryLocations,  List<String> connectionAttestations,  List<ContactIntroduction> introductions,  List<RecordKey> recordsToPin,  PublicKey? identityKey,  PublicKey? introductionKey,  String? pushNotificationTopic,  int schemaVersion)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContactSharingSchemaV3() when $default != null:
return $default(_that.details,_that.addressLocations,_that.temporaryLocations,_that.connectionAttestations,_that.introductions,_that.recordsToPin,_that.identityKey,_that.introductionKey,_that.pushNotificationTopic,_that.schemaVersion);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ContactDetails details,  Map<String, ContactAddressLocation> addressLocations,  Map<String, ContactTemporaryLocation> temporaryLocations,  List<String> connectionAttestations,  List<ContactIntroduction> introductions,  List<RecordKey> recordsToPin,  PublicKey? identityKey,  PublicKey? introductionKey,  String? pushNotificationTopic,  int schemaVersion)  $default,) {final _that = this;
switch (_that) {
case _ContactSharingSchemaV3():
return $default(_that.details,_that.addressLocations,_that.temporaryLocations,_that.connectionAttestations,_that.introductions,_that.recordsToPin,_that.identityKey,_that.introductionKey,_that.pushNotificationTopic,_that.schemaVersion);}
}
